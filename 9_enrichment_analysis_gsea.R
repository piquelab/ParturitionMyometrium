...
######################################################################
# Gene set enrichment analysis based on the ranked list of genes from reference and  cell type DEGs as customized gene sets.
######################################################################
...
# cell markers as customized gene sets 
